...
class all_methods:
    ...
    def signup(self):
        ...
        method_response = Validations_obj.missingFields_validation(data)
        if method_response is not None:
            return method_response
        ...
        user_id=Validations_obj.generate_unique_user_id()
        ...
        #     return jsonify(error_response), 400
        method_response3=Validations_obj.emailValidation(email)
        if method_response3 is not None:
            return method_response3
        ...
        #     return jsonify(error_response), 400
        method_response4 = Validations_obj.phoneNumberValidation(phone_number)
        if method_response4 is not None:
            return method_response4
        ...
        #     return jsonify(error_response), 400
        method_response5=Validations_obj.nameValidation(First_Name)
        if method_response5 is not None:
            return method_response5
        ...
        method_response6=Validations_obj.nameValidation(Last_Name)
        if method_response6 is not None:
            return method_response6
    ...
    def signin(self,a):
        ...
        method_response1=Validations_obj.missingFieldValidation_username(username)
        if method_response1 is not None:
            return method_response1
        ...
        #     return jsonify(error_response), 400
        method_response2=Validations_obj.missingFieldValidation_password(password)
    ...
    def forgot_password(self):
        ...
        #     return jsonify(error_response), 400
        method_response=Validations_obj.missingFieldValidation_email(email)
        if method_response is not None:
            return method_response
        ...
        #     return jsonify(error_response), 400
        method_response1=Validations_obj.emailValidation(email)
        if method_response1 is not None:
            return method_response1
    ...
    def update_password(self):
        ...
        method_response=Validations_obj.tokenMissing(token)
        if method_response is not None:
            return method_response
        ...
        method_response1=Validations_obj.newPassword_confirmPassword_validation(new_password,confirm_password)
        if method_response1 is not None:
            return method_response1
    ...
    def upload_image(self,username):
        ...
        method_response=Validations_obj.notImage_validation()
        if method_response is not None:
            return method_response
        ...
        #     return jsonify(error_response), 400
        method_response=Validations_obj.filenameAndExtension_validation()
        if method_response is not None:
            return method_response
